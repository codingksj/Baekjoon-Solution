...
bool Input();
void Solve();
void DFS(const string pwd, const int depth, const int idx);
bool CheckVowel(const char& ch);
void Output();
// ---------- 열거형 상수 ----------
