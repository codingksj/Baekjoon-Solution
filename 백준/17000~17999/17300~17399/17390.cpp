...
//사용자 지정 함수
vector<int> MakePrefixSum(const vector<int>& V, const int N);
void DoQuery(const vector<int>& pfV, const int Q);
...
vector<int> MakePrefixSum(const vector<int>& V, const int N) {
    vector<int> pfV = InitVector<int>(N + 1, 0);
