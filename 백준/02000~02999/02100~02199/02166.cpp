...
// ---------- 사용자 정의 함수 및 연산자 ----------
vector<Point2D<LL>> LoadPoints(const int N);
double CalcPolygonArea(const vector<Point2D<LL>>& points, const int N);
