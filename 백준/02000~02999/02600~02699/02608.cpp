...
// ---------- 사용자 정의 함수 ----------
string ToRoman(const int decimal);
int ToDecimal(const string& roman);
...
int main() {
    ...
    string roman1, roman2, romanSum;
    int decimal1, decimal2, decimalSum;

    getline(cin, roman1);
    getline(cin, roman2);

    decimal1 = ToDecimal(roman1);
    decimal2 = ToDecimal(roman2);
    decimalSum = decimal1 + decimal2;
    romanSum = ToRoman(decimalSum);
