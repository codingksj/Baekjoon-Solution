...
bool Input();
void Solve();
void Star(const int sz, const int r, const int c);
void Output();
// ---------- 열거형 상수 ----------

// ---------- 전역 변수 ----------
Words stars;
const vector<Pii> fills = {
    Pii(1,3),
    Pii(2,3),
    Pii(3,1), Pii(3,2), Pii(3,3), Pii(3,4), Pii(3,5),
    Pii(4,2), Pii(4,3), Pii(4,4),
    Pii(5,2), Pii(5,4)
};
int N, X;
