...
void LoadCityMap();
void FindMinDist();
void DFS(const int depth, const int startIdx);
...
// ---------- 전역 변수 ----------
vector<Pii> chickens, selects;
vector<Pii> houses;
vector<bool> dfsCheck;
int mapSize, N, M;
int minTotalDist = BILLION;
