...
int main() {
    ...
    vector<int> superPrimes = LoadSuperPrimes();
    int TC, N;
...
vector<int> LoadSuperPrimes() {
    ...
    vector<int> superPrimes = { 0 };
    vector<bool> isPrimes = InitVector<bool>(MAX_N + 1, true);
    ...
    for (int i = 1; i <= 3000; i++) {
        superPrimes.push_back(primes[primes[i]]);
    }
