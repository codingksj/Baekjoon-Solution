...
vector<TLL3> solutions = {
        ...
        {LLONG_MAX, LLONG_MAX, LLONG_MAX},
        {LLONG_MAX, LLONG_MAX, LLONG_MAX},
        {8866128975287528LL, -8778405442862239LL, -2736111468807040LL},
        {-1, 2, 3},
        {0, 2, 3},
        {1, 2, 3},
        {0, -3, 4},
...
TLL3 noSol = { LLONG_MAX, LLONG_MAX, LLONG_MAX };
int N;
...
void Output() {
    if (solutions[N] != noSol) {
        auto& [x, y, z] = solutions[N];
        cout << x << " " << y << " " << z << "\n";
    }
    else {
        cout << 0 << "\n";
