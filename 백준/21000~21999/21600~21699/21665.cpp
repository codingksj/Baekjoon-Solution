...
// ---------- 사용자 정의 함수 및 연산자 ----------
int CalcWrongPixel(const Words& img1, const Words& img2, const int R, const int C);
...
int main() {
    ...
    img1 = LoadVector<string>(R);
    img2 = LoadVector<string>(R);

    cout << CalcWrongPixel(img1, img2, R, C) << "\n";
