...
// ---------- 사용자 정의 함수 ----------
int CalcMaxSnakeBirdLength(const vector<int>& fruits, const int L);
...
int main() {
    ...
    fruits = LoadVector<int>(N);
    Sort(fruits);
    maxLength = CalcMaxSnakeBirdLength(fruits, L);
