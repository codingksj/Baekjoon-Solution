...
enum OPERATIONS : int { SET = 1, PRINT, ADD, MUL, SUB, DIV, STOP };
...
void Solve() {
	switch (oper) {
		case SET: cin >> var1 >> n; (var1 == 'A' ? A : B) = n; break;
		case PRINT: cin >> var1; cout << (var1 == 'A' ? A : B) << "\n"; break;
		case ADD: cin >> var1 >> var2; (var1 == 'A' ? A : B) = (var1 == 'A' ? A : B) + (var2 == 'A' ? A : B); break;
		case MUL : cin >> var1 >> var2; (var1 == 'A' ? A : B) = (var1 == 'A' ? A : B) * (var2 == 'A' ? A : B); break;
		case SUB : cin >> var1 >> var2; (var1 == 'A' ? A : B) = (var1 == 'A' ? A : B) - (var2 == 'A' ? A : B); break;
		case DIV: cin >> var1 >> var2; (var1 == 'A' ? A : B) = (var1 == 'A' ? A : B) / (var2 == 'A' ? A : B); break;
	}
	return;
};
