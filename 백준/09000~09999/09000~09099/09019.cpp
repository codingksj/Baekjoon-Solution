...
//사용자 지정 함수
string FindMinCommands(vector<bool>& bfsCheck, const int src, const int dest);
...
int main() {
    ...
    while (TC--) {
        ...
        bfsCheck = InitVector<bool>(10 * THOUSAND, false);
        commands = FindMinCommands(bfsCheck, A, B);
